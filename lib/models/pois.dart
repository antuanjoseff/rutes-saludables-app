...
var pointsOfInterest = [
  ...
  Feature(
      ...
      properties: Properties(
        ...
        description:
            '<p>Un espai ple d’història, on hi ha les restes de la caserna on es van instal·lar els soldats mercenaris alemanys destinats a Girona a final del segle XVII i que fou destruïda durant la guerra del Francès.</p><Iframe frameborder="0" src="//www.youtube.com/embed/uD4DjY99FYc" width="640" height="360" class="note-video-clip"/>',
        // icon: 'account_balance',
        // url: ''
      )),
  Feature(
      ...
      properties: Properties(
        ...
        description:
            '<p>Els Jardins de la Francesa reben aquest nom per la nacionalitat de la seva antiga propietària. S’ubiquen darrere de l’àbsida de la catedral, al costat del Palau de l’Arquebisbe i amb vistes al Canigó, a la torre romànica de Carlemany annexa a la catedral i la gàrgola de la bruixa.</p><iframe frameborder="0" src="//www.youtube.com/embed/6D6cwNKK6vU" width="640" height="360" class="note-video-clip"/>',
        // icon: 'account_balance',
        // url: ''
      )),
  Feature(
